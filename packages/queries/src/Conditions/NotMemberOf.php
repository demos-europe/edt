 ...
 */
class NotMemberOf extends AbstractCondition implements ValueDependentConditionInterface
{
    public const OPERATOR = 'NOT MEMBER OF';
    ...
    public function transform(?array $path, mixed $value): PathsBasedInterface
    {
        ...
        return $this->conditionFactory->propertyHasNotStringAsMember($value, $path);
    }
}
