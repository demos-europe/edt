 ...
 */
class ContainsAll extends AbstractCondition implements ValueDependentConditionInterface
{
    public const OPERATOR = 'CONTAINS ALL';
    ...
    public function transform(?array $path, mixed $value): PathsBasedInterface
    {
        ...
        return $this->conditionFactory->allValuesPresentInMemberListProperties($value, $path);
    }
}
