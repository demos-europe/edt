 ...
 */
class EndsWith extends AbstractCondition implements ValueDependentConditionInterface
{
    public const OPERATOR = 'ENDS_WITH_CASE_INSENSITIVE';
    ...
    public function transform(?array $path, mixed $value): PathsBasedInterface
    {
        ...
        return $this->conditionFactory->propertyEndsWithCaseInsensitive($value, $path);
    }
}
