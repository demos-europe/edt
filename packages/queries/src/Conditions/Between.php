 ...
 */
class Between extends AbstractCondition implements ValueDependentConditionInterface
{
    ...
    public function transform(?array $path, mixed $value): PathsBasedInterface
    {
        ...
        [$min, $max] = $value;
        return $this->conditionFactory->propertyBetweenValuesInclusive($min, $max, $path);
    }
}
