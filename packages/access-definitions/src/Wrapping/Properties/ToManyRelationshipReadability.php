...
{
    /**
     * @param null|callable(TEntity): iterable<TRelationship|WrapperObject<TRelationship>> $customReadCallback
    ...
    /**
     * @return null|callable(TEntity): iterable<TRelationship|WrapperObject<TRelationship>>
     */
