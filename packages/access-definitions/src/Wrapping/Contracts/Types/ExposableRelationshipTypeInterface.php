...
interface ExposableRelationshipTypeInterface
{
     ...
     * relationship using {@link TransferableTypeInterface::getReadability()} in A, B and C
     ...
     *
     * @deprecated will be removed to reduce usage complexity, evaluate the conditions when returning relationships in methods like {@link TransferableTypeInterface::getReadability()} instead
     */
